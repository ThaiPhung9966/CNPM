    ...
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                <a href="trang-chu">
                    <img src="public/images/logo2.jpg" style="width: 80%;" class="img-fix f-logo" alt="smart-construction">
                </a>
                <div class="about-store">
                 XT Mobile. Chất lượng - giá cả hợp lý
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span> 134 Uy Nỗ, Đông Anh, Hà Nội</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span> 0986558185 </span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="">kidthai968@gmail.com</span>
                    </li>
                </ul>
            </div>
        </div>
